  ...
  <div class="administrativedivision flex_fs">
    ...
    <div class="isleft">
      <is-left :treedata="treedata" :replaceFields="replaceFields" :defaultExpandedKeys="defaultExpandedKeys"
        :defaultSelectedKeys="defaultSelectedKeys" @selectdata="getselectdata" @searchdata="getsearchdata" v-if="showtree"></is-left>
    </div>
    <div class="right_box">
      <div class="right right4">
        ...
        <div class="table" v-if="tabletype">
          <a-table :scroll="{  y: 610 }" :columns="tablecolumns" :data-source="tabledata" bordered :pagination="pagination"
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      //   demo: 'dddddddd'
      // }
      // this.$store.commit('setNavValue', param);
      // console.log("---------------", this.$store.state.navValue)
    },
    methods: {
      //行政区划树
      async getareatree() {

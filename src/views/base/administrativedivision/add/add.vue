<template>
  <div class="isedit">
    ...
    <div class="flexrow flexac edit_item">
      ...
      <a-input class="edit_a_input" placeholder="2-16个中文汉字组合" />
    ...
    <div class="flexrow flexac edit_item">
      ...
      <a-input class="edit_a_input" v-model="adress" placeholder="在地图定位后获取" />
    ...
    <div class="flexrow flexac edit_item">
      ...
      <div style="position: relative;">
        <a-textarea class="edit_a_input" :rows="5" placeholder="格式不限制，256个字符以内，包含标点符号" />
  ...
  methods: {
    ...
    init() {
      ...
      map.on("click", function (params) {
        ...
        _that.adress = params.lnglat.lng + "," + params.lnglat.lat;
        ...
        _that.$message.success(
          "当前经纬度为" + _that.form.longitude + "," + _that.form.latitude
        );
    ...
    getLatLngLocation() {
      ...
      geocoder.getLocation(_that.city, (status, result) => {
        if (status === "complete" && result.geocodes.length) {
          ...
          _that.adress = lnglat.lng + "," + lnglat.lat;
          this.init();
        } else {
          console.log(result);
        }
